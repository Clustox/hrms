<template>
	<div
		...
		:class="[
			props.view === 'form'
				? 'px-4 pt-4 pb-4 standalone:pb-safe-bottom sm:w-96 form-view-shell bg-white sticky bottom-0 w-full drop-shadow-xl z-40 border-t rounded-t-lg lg:max-w-2xl lg:mx-auto lg:rounded-lg lg:border lg:mb-6'
